                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $row['name'] ?></td>
                                            <td>
                                                <a href="view_type.php?id=<?= $row['id'] ?>" class="my-1 btn btn-sm btn-primary">View</a>
                                                <a href="form_type.php?id=<?= $row['id'] ?>" class="my-1 btn btn-sm btn-warning">Edit</a>
                                                <a href="delete_type.php?id=<?= $row['id'] ?>" class="my-1 btn btn-sm btn-danger" onclick="if(!confirm('Anda Yakin Hapus Data Produk <?= $row['name'] ?>?')) {return false}">Delete</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
