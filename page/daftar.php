...
<head>
    ...
    <title>Daftar - M-Store Admin</title>
...
<body>
    ...
    <div id="layoutAuthentication">
                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    <form>
                                        ...
                                        <div class="mt-4 mb-0">
                                            <div class="d-grid"><a class="btn btn-dark btn-block" onclick="akun()" href="login.php">Buat Akun</a></div>
                                        </div>
                                    </form>
                                </div>
                                <div class="card-footer bg-dark text-center py-3">
                                    <div class="small"><a class="text-white" href="login.php">Mempunyai akun? login</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div id="layoutAuthentication_footer">
            <footer class="py-4 mt-5 bg-dark shadow-lg">
